...
window.BMap_offlineUrl = "http://172.17.225.112/tile/maptile3/";
// window.BMap_offlineUrl = "http://www.map.com/maptile/";
// window.BMap_offlineUrl = "http://10.169.52.247:8089/maptile/";
...
(function() {
    ...
    x.object.extend(I, {
        ...
        s3: {},
        aG: {
            MP: "./scripts/lib/bdjs/getmodules?v=2.0",
            oU: 5E3
        },
        zC: q,
        Md: {
            ...
            if (d.Bd == this.Fj.Zp) c && b();
                ...
                if (d.Bd == this.Fj.hG) {
                    ...
                    e.zC == q && (e.zC = o, setTimeout(function() {
                        ...
                        if (a.length > 0) {
                            console.log(a);
                            Pb("../../scripts/lib/bdjs/getmodules2.js");
                        } else {
                            e.LK()
                        }
                    }, 1));
    ...
    x.extend(vc.prototype, {
        ra: function (a) {
            var b = this;
            b.map = this.C = a;
            b.wc = document.createElement("canvas");
            b.wc.style.cssText = "position: absolute; left: 0; top: 0;";
            b.V = b.wc;
            a = b.map.wb();
            b.wc.width = a.width;
            b.wc.height = a.height;
            b.wc.id = "myCanvasElement";
            b.map.Qf().ot.appendChild(b.wc);
            b.Ay = new NNf;
            b.hi();
            b.map.addEventListener("click", function (a) {
                a = OOf(b.Ay, a.offsetX, a.offsetY);
                a !== p && b.dispatchEvent("click", {point: a.point})
            });
            b.Nk = p;
            b.map.addEventListener("mousemove", function (a) {
                for (var d = b.map.qx(), e = d.length, f = p, g = 0; g < e && !(d[g] instanceof z.PointCollection && (f = OOf(d[g].Ay, a.offsetX, a.offsetY), f !== p)); g++);
                f === p ? (b.Nk !== p && (b.dispatchEvent("mouseout", {point: b.Nk.point}), b.Nk = p), b.wc.style.cursor = "") : (b.Nk === p ? (b.dispatchEvent("mouseover", {point: f.point}), b.Nk = f) : b.Nk !== f && (b.dispatchEvent("mouseout", {point: b.Nk.point}), b.dispatchEvent("mouseover", {point: f.point}), b.Nk = f), b.wc.style.cursor = "pointer")
            });
            return b.wc
        }, hi: function () {
            this.Ay.data.yF = [];
            var a = this.map.wb();
            this.wc.width = a.width;
            this.wc.height = a.height;
            this.wc.style.left = this.map.te.style.left;
            this.wc.style.top = this.map.te.style.top;
            if (this.da.ia && this.da.ia.length) {
                this.wc.getContext("2d").clearRect(0, 0, this.wc.width, this.wc.height);
                -1 !== document.location.href.indexOf(".local") && (console && console.time) && console.time("\u904d\u5386\u7ed8\u5236\u9ebb\u70b9");
                this.wc.getContext("2d").beginPath();
                for (var b = 0, c; c = this.da.ia[b]; b++) {
                    var d = this.map.fc(c);
                    if (!(0 > d.x || 0 > d.y || d.x > a.width || d.y > a.height)) {
                        var e;
                        switch (this.z.shape) {
                            case 1:
                                e = new PPf;
                        ...
                        switch (this.z.size) {
                            case 1:
                                ("circle" === e.type || "star" === e.type) && e.vf(1);
                                if ("rectangle" === e.type || "rhombus" === e.type)e.Ch(2), e.Ah(2);
                                break;
                            case 2:
                                ("circle" === e.type || "star" === e.type) && e.vf(2);
                                if ("rectangle" === e.type || "rhombus" === e.type)e.Ch(4), e.Ah(4);
                                break;
                            case 3:
                                ("circle" === e.type || "star" === e.type) && e.vf(4);
                                if ("rectangle" === e.type || "rhombus" === e.type)e.Ch(8), e.Ah(8);
                                break;
                            case wc:
                                ("circle" === e.type || "star" === e.type) && e.vf(5);
                                if ("rectangle" === e.type || "rhombus" === e.type)e.Ch(10), e.Ah(10);
                                break;
                            case 5:
                                ("circle" === e.type || "star" === e.type) && e.vf(8);
                                if ("rectangle" === e.type || "rhombus" === e.type)e.Ch(16), e.Ah(16);
                                break;
                            case 6:
                                ("circle" === e.type || "star" === e.type) && e.vf(10);
                                if ("rectangle" === e.type || "rhombus" === e.type)e.Ch(20), e.Ah(20);
                                break;
                            case 7:
                                ("circle" === e.type || "star" === e.type) && e.vf(15);
                                if ("rectangle" === e.type || "rhombus" === e.type)e.Ch(30), e.Ah(30);
                                break;
                            default:
                                if (("circle" === e.type || "star" === e.type) && e.vf(5), "rectangle" === e.type || "rhombus" === e.type)e.Ch(10), e.Ah(10)
                        }


                        if(!this.z.img)this.z.img=z.ma + "images/point-collection/red-marker-10x13.png";
                        ...
                        if(!UUf[this.z.img]){
                            ...
                            temp.img.src=this.z.img;
                        }
                        e.UUf=UUf[this.z.img];



                        //this.UUf = document.createElement("img"), VVf = q;
                        //
                        //    this.UUf.src=this.z.img;


                        this.z.color && ("circle" === e.type || "star" === e.type || "rectangle" === e.type || "rhombus" === e.type) && e.Jk(this.z.color);
                        e.Jo(this.wc.getContext("2d"), d.x, d.y);
                        e.point = c;
                        this.Ay.data.yF.push(e)
                    }
                }
                this.wc.getContext("2d").fillStyle = this.z.color;
                this.wc.getContext("2d").fill();
                -1 !== document.location.href.indexOf(".local") && (console && console.timeEnd) && console.timeEnd("\u904d\u5386\u7ed8\u5236\u9ebb\u70b9")
            }
        }, c_: function (a) {
            this.da.ia = a;
            this.hi()
        }, yi: function (a) {
            a.color && (this.z.color = a.color);
            a.size && (this.z.size = a.size);
            a.shape && (this.z.shape = a.shape);
            this.hi()
        }, clear: function () {
            this.da.ia = [];
            this.hi()
            ...
            this.clear();
            this.wc && this.wc.parentNode && this.wc.parentNode.removeChild(this.wc);
            // this.dispatchEvent(new O("onremove"))
        }
    });
    vc.prototype.initialize = vc.prototype.ra;
    vc.prototype.draw = vc.prototype.hi;
    vc.prototype.setPoints = vc.prototype.c_;
    vc.prototype.setStyles = vc.prototype.yi;
    ...
    function OOf(a, b, c) {
        for (var d = 0, e; e = a.data.yF[d]; d++)if (e.uk(), b > e.position.x - e.ep() / 2 && b < e.position.x + e.ep() / 2 && c > e.position.y - e.uk() / 2 && c < e.position.y + e.uk() / 2)return e;
        return p
    }
    function QQf() {
        this.type = "waterdrop";
    ...
    var UUf ={};
    var WWf = document.createElement("img");
    WWf.onload = s();
    WWf.src = z.ma + "images/blank.gif";
    QQf.prototype.Jo = function (a, b, c) {
        var d = this;

        if(this.UUf.load){
            (d.G1 = a, d.position.x = b, d.position.y = c, a.save(), a.translate(b - d.UUf.img.width / 2, c - d.UUf.img.height / 2), a.drawImage(d.UUf.img, 0, 0, d.UUf.img.width, d.UUf.img.height, 0, 0, d.UUf.img.width, d.UUf.img.height), a.restore())
    ...
    QQf.prototype.ha = t("position");
    QQf.prototype.ep = function () {
        return this.UUf.img.width
    };
    QQf.prototype.uk = function () {
        return this.UUf.img.height
    };
    function Tf(a) {
        this.type = "circle";
        a = a || {};
        this.K = {xa: a.radius || 10, color: a.color || "#fa937e"};
        this.position = {x: 0, y: 0}
    }
    dda = Tf.prototype;
    dda.Jo = function (a, b, c) {
        this.position.x = b;
        this.position.y = c;
        a.save();
        a.translate(b, c);
        a.beginPath();
        a.fillStyle = this.K.color;
        a.arc(0, 0, this.K.xa, 0, 2 * Math.PI, q);
        a.fill();
        a.restore()
    };
    dda.vf = function (a) {
    ...
    function Pf(a) {
        this.type = "star";
        a = a || {};
        this.K = {xa: a.radius || 10, UE: a.pointsNumber || 5, HW: a.fraction || 0.4, color: a.color || "#fa937e"};
        this.position = {x: 0, y: 0}
    }
    dda = Pf.prototype;
    dda.Jo = function (a, b, c) {
        ...
        a.beginPath();
        a.translate(b, c);
        a.moveTo(0, 0 - this.K.xa);
        for (b = 0; b < this.K.UE; b++)a.rotate(Math.PI / this.K.UE), a.lineTo(0, 0 - this.K.xa * this.K.HW), a.rotate(Math.PI / this.K.UE), a.lineTo(0, 0 - this.K.xa);
        a.fill();
        a.restore()
    };
    dda.vf = function (a) {
    ...
    function Rf(a) {
        this.type = "rectangle";
        a = a || {};
        this.K = {width: a.width || 10, height: a.height || 10, color: a.color || "#fa937e"};
        this.position = {x: 0, y: 0}
    }
    dda = Rf.prototype;
    dda.Jo = function (a, b, c) {
        ...
        this.position.y = c;
        a.save();
        a.translate(b - this.K.width / 2, c - this.K.height / 2);
        a.fillStyle = this.K.color;
        a.fillRect(0, 0, this.K.width, this.K.height);
        a.restore()
    };
    dda.Ch = function (a) {
        this.K.width = a
    ...
    dda.Jo = function (a, b, c) {
        ...
        a.translate(b - this.K.width / 2, c - this.K.height / 2);
        a.beginPath();
        a.moveTo(0 + 0.5 * this.K.width, 0);
        a.lineTo(0, 0 + 0.5 * this.K.height);
        a.lineTo(0 + 0.5 * this.K.width, 0 + this.K.height);
        a.lineTo(0 + this.K.width, 0 + 0.5 * this.K.height);
        a.lineTo(0 + 0.5 * this.K.width, 0);
        a.closePath();
        a.fill();
        a.restore()
    };
    ...
    Uc.getTilesUrl = function(a, b, c) {
        var x = a.x,
            ...
            e = 1,
            z = b;
        return BMap_offlineUrl + z + "/" + x + "/" + y + ".jpg";
    };
    var La = new Qc("\u5730\u56fe", Uc, {
            tips: "\u663e\u793a\u666e\u901a\u5730\u56fe",
            maxZoom: 19
